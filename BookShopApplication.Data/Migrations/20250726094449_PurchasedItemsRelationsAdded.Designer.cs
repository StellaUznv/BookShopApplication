...
namespace BookShopApplication.Data.Migrations
{
    ...
    [Migration("20250726094449_PurchasedItemsRelationsAdded")]
    partial class PurchasedItemsRelationsAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookShopApplication.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0df85b04-0d74-41c0-9912-9f1ed699fc9f",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEI+v5C2cjmTsvSmMyqXud/tYX7Fand7gs+cyiD2jZl/yAJK9IiGgF1O3I7djBhXgAA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "b2d5f250-3cdb-4459-80a2-ccc85d975d36",
            ...
            modelBuilder.Entity("BookShopApplication.Data.Models.PurchaseItemUser", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BookShopApplication.Data.Models.PurchaseItemUser", b =>
                {
                    b.HasOne("BookShopApplication.Data.Models.CartItem", "CartItem")
                        .WithMany("PurchasedItemByUsers")
                        .HasForeignKey("CartItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookShopApplication.Data.Models.ApplicationUser", "User")
                        .WithMany("PurchasedItemsByUser")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BookShopApplication.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("PurchasedItemsByUser");
            ...
            modelBuilder.Entity("BookShopApplication.Data.Models.CartItem", b =>
                {
                    b.Navigation("PurchasedItemByUsers");
                });
